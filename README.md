...
* **Android Studio:** Digunakan sebagai **Integrated Development Environment (IDE)** untuk membangun (*build*), mengompilasi, dan menginstall aplikasi Android ke perangkat fisik atau emulator baik untuk proyek `tugas2/` dan `tugas3/`).
